				...
				<div>
					<div class="col m12">
						...
						<div class="card padding-down-5">	
							...
							<div class="row">
			<div class="col m4 offset-m1"><button @click="register" class="waves-effect waves-light btn-large"><i class="material-icons left">edit</i>Update Profile</button></div>
		</div>
						</div>
					</div>
				</div>
